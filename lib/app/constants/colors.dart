...
class AppColors {
  static Color backgroundColor = const Color(0xFFFFF6E7);
  static Color primaryColor = Color.fromARGB(255, 101, 131, 172);
  static Color skyblueColor = Color.fromARGB(255, 155, 186, 253);
  static Color blueColor = Color.fromARGB(255, 99, 16, 207);
  static Color blackColor = Color.fromARGB(255, 0, 0, 0);
  static Color redColor = Color.fromARGB(202, 255, 6, 6);
